...
},{"./active.coffee":10,"./wiki.coffee":2}],11:[function(require,module,exports){
...
},{"./addToJournal.coffee":13,"./neighborhood.coffee":12,"./pageHandler.coffee":7,"./plugin.coffee":8,"./state.coffee":9,"./util.coffee":6,"./wiki.coffee":2,"underscore":14}],7:[function(require,module,exports){
var IDBStore, addToJournal, pageFromLocalStorage, pageHandler, pushToLocal, pushToServer, recursiveGet, repository, revision, state, util, wiki, _;
...
pageHandler.put = function(pageElement, action) {
  ...
  if (wiki.useLocalStorage() || pagePutInfo.site === 'local') {
    ...
    return pushToLocal(pageElement, pagePutInfo, action);
  }
};


},{"./addToJournal.coffee":13,"./repository.coffee":16,"./revision.coffee":15,"./state.coffee":9,"./util.coffee":6,"./wiki.coffee":2,"idb-wrapper":17,"underscore":14}],14:[function(require,module,exports){
...
},{"./util.coffee":6}],12:[function(require,module,exports){
...
},{"./active.coffee":10,"./search.coffee":18,"./util.coffee":6,"./wiki.coffee":2,"underscore":14}],16:[function(require,module,exports){
...
},{"idb-wrapper":17}],18:[function(require,module,exports){
